...
def _build_bridges_prompt(
    *,
    ...
    return (
        ...
        "Where it says 'BRIDGE CROSSES CATEGORY', write ONE flowing sentence of at least ~12 words "
        "that does BOTH jobs — names the new category naturally AND hooks the next story's specific "
